                ...
                <form method="post" action="{{ route('exercicio.update', $exercicio->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="nm_grupo_muscular_exercicio" id="nm_grupo_muscular_exercicio" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('nm_grupo_muscular_exercicio', $exercicio->nm_grupo_muscular_exercicio) }}" />
